    ...
    if opcion == "1":
        ...
        if nombre == "":
            ...
            if re.match("[A-Za-z ]+", nombre):
                cancion = mi_playlist.buscar_cancion(nombre)
        ...
        while True: # crear un bucle infinito
            print("<><><><><><><><><><><><><")
        ...
        while True: # crear un bucle infinito
            ...
            opcion = input("Elige una opción: ") 
            if opcion == "1": 
                mi_playlist.ordenar_por_numero(0) # reproducir la playlist
            elif opcion == "2": 
                mi_playlist.ordenar_por_numero(1) # reproducir la canción anterior
            elif opcion == "3": 
        ...
        while True: # crear un bucle infinito
            ...
            opcion = input("Elige una opción: ") 
            if opcion == "1": 
                mi_playlist.ordenar_por_reproducciones(0) # reproducir la playlist
            elif opcion == "2": 
                mi_playlist.ordenar_por_reproducciones(1) # reproducir la canción anterior
            elif opcion == "3": 
                print("Volver al menú.") 
                break # salir del bucle y terminar el programa
            else: 
        ...
        while True: # crear un bucle infinito
            ...
            opcion = input("Elige una opción: ") 
            if opcion == "1": 
                mi_playlist.ordenar_por_nombre(0) # reproducir la playlist
            elif opcion == "2": 
                mi_playlist.ordenar_por_nombre(1) # reproducir la canción anterior
            elif opcion == "3": 
                print("Volver al menú.") 
                break # salir del bucle y terminar el programa
            else: 
